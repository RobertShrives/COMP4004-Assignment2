...
public class BorrowCopyInvalidStepDefs {
	...
	public void when_I_create_the_first_user_darren_carleton_ca_and_second_user_will_carleton_ca(String arg1, String arg2) throws Throwable {
	   System.out.println( i.processInput(""+ arg1 +",pass1", InputHandler.CREATEUSER).getOutput());
	   System.out.println( i.processInput(""+ arg2 +",pass1", InputHandler.CREATEUSER).getOutput());
	}
	...
	public void i_create_the_title_with_the_title_and_ISBN_number(String arg1, String arg2) throws Throwable {
		 System.out.println( i.processInput(""+ arg2 +","+arg1 +"", InputHandler.CREATETITLE).getOutput());
	}
	...
	@Given("^when I create the user (.*)$")
	public void when_I_create_the_user_Joan_carleton_ca(String arg1) throws Throwable {
		 System.out.println( i.processInput(""+ arg1 +",pass1", InputHandler.CREATEUSER).getOutput());
	}
	
	@Given("^The user renews the title with the information \"([^\"]*)\"$")
	public void the_user_renews_the_title_with_the_information(String arg1) throws Throwable {
		 System.out.println( i.processInput(arg1, InputHandler.RENEW).getOutput());
	}
	...
	public void i_have_the_first_user_darren_carleton_ca_borrow_the_copy_number_with_the_ISBN_number(String arg1, int arg2, String arg3) throws Throwable {
		 System.out.println( i.processInput(""+arg1+","+arg3+","+arg2+"", InputHandler.BORROW).getOutput());
	}
	...
	public void i_have_the_first_user_mark_carleton_ca_renew_the_copy_number_with_the_ISBN_number(String arg1, int arg2, String arg3) throws Throwable {
		 System.out.println( i.processInput(""+arg1+","+arg3+","+arg2+"", InputHandler.RENEW).getOutput());
	}
	...
	public void i_have_the_second_user_will_carleton_ca_try_to_borrow_the_copy_number_with_the_ISBN_number(String arg1, int arg2, String arg3) throws Throwable {
		 result = i.processInput(""+arg1+","+arg3+","+arg2+"", InputHandler.BORROW).getOutput();
	}
	...
	public void i_have_the_first_user_clarence_carleton_ca_return_the_copy_number_with_the_ISBN_number(String arg1, int arg2, String arg3) throws Throwable {
		 System.out.println( i.processInput(""+arg1+","+arg3+","+arg2+"", InputHandler.RETURN).getOutput());
	}
