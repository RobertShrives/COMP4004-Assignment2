...
public class TitleTable {
	...
	public Object delete(String string) {
		...
		if(flag!=0){
			...
			boolean itemExists = ItemTable.getInstance().itemExists(string);
			System.out.println(loan);
			if(itemExists == true){
		    	result="Active Item Exists";
...
//    	result="Active Item Exists";
//		logger.info(String.format("Operation:Delete Title;ISBN Info:[%s];State:Fail;Reason:Active Item Exists.", string));
//		}
        if (!loan){
